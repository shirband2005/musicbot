...
# گروه جستجو: یوزربات کمکی اینجا به ربات جستجو inline query می‌زند و فایل را
# می‌گیرد. **ربات پلیر لازم نیست عضو باشد** — تلگرام به ربات‌ها اجازه‌ی inline
# زدن به ربات دیگر را نمی‌دهد، پس این کار با یوزربات انجام می‌شود.
SEARCH_GROUP = _int("SEARCH_GROUP")
